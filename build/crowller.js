...
var Crowller = /** @class */ (function () {
    function Crowller(url, course) {
        this.url = url;
        this.course = course;
        this.filePath = path_1.default.resolve(__dirname, '../data/course.json'); // 写入的 json 路径
        this.initSpider();
    }
    // 获取爬虫地址所对应的html
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        fileContent = this.course.analyze(html, this.filePath);
...
var course = course_1.default.getInstance();
